  ...
  return (
    <div className="py-10 px-4">
      <div className="flex mb-5 border-b-2 pb-5">
        <div className="w-14 h-14 bg-gray-700 rounded-full mr-2" />
        <div className="flex flex-col">
          <span>Steve Jebs</span>
          <span className="text-gray-500">Edit profile &rarr;</span>
        </div>
      </div>
      <div className="flex justify-between px-10">
        <Link href={`profile/sold`}>
          <div className="flex flex-col items-center">
            <div className="w-10 h-10 rounded-full bg-orange-500 flex justify-center items-center text-gray-100">
              <svg
                className="w-6 h-6"
                fill="none"
                stroke="currentColor"
            ...
            <span className="font-semibold text-sm mt-1 text-gray-700">
              판매내역
            </span>
          </div>
        </Link>
      ...
      <div>
        <div className="flex mt-5 mb-2">
          <div className="w-10 h-10 bg-gray-600 rounded-full mr-2" />
          <div>
            <h4 className="font-bold text-gray-900">니꼬</h4>
            <div className="flex">
              <svg
